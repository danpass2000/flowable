...
public class IdmSecurityConfiguration {
    ...
    @Bean
    public org.flowable.ui.idm.security.UacUserDetailsService userDetailsService() { //^^
        org.flowable.ui.idm.security.UacUserDetailsService u = new org.flowable.ui.idm.security.UacUserDetailsService();
        u.setUserValidityPeriod(idmAppProperties.getSecurity().getUserValidityPeriod());
        return u;
    }
