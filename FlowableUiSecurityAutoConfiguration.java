...
public class FlowableUiSecurityAutoConfiguration {
    ...
    public static class FormLoginWebSecurityConfigurerAdapter extends WebSecurityConfigurerAdapter {
        ...
        @Override
            ...
            auth.authenticationProvider(new UacAuthenticationProvider()); //^^
        }
        ...
        // */
        // @Bean
        // public BCryptPasswordEncoder xpasswordEncoder() {
        ...
        //             .withUser("xxx").password(xpasswordEncoder()
        //             .encode("123")).roles("ROLEx_ADMIN");
        // }
        ...
        public void configure(WebSecurity web) throws Exception { //^^
            // 静态资源的访问不需要拦截，直接放行
            web.ignoring().antMatchers("/**/*.css", "/**/*.js", "/**/*.png", "/**/*.jpg", "/**/*.html", "/**/*.json", "/**/*.woff");
        }
    }
