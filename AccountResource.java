...
public class AccountResource {
    ...
    public UserRepresentation getAccount(Authentication authentication) {
        ...
        if (userRepresentation == null) {
            ...
            userRepresentation = getCurrentUserRepresentationDaniel(authentication); //^^
        }
    ...
    protected UserRepresentation getCurrentUserRepresentationDaniel(Authentication authentication) {

        if (authentication.getName() != null)
        {
            UserRepresentation userRepresentation = new UserRepresentation(authentication.getName());
            return userRepresentation;
        }
        else {
            return null;
